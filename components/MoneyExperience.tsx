              ...
              <div className="space-y-3">
                {page.map((point) => {
                  ...
                  return (
                    ...
                    >
                      <p className="pr-2 text-xs font-semibold leading-tight text-slate-500">
                        {point.label}
                      </p>

                      {showExpenses ? (
                        <>
                          <p className="pr-4 text-left text-[10px] font-semibold leading-none text-rose-700">
                      ...
                      <p className="pl-4 text-right text-[10px] font-semibold leading-none text-emerald-700">
