              ...
              <div className="space-y-3">
                {page.map((point) => {
                  ...
                  return (
                    ...
                    >
                      <p className="truncate pr-2 text-xs font-semibold text-slate-500">
                        {point.label}
                      </p>

                      {showExpenses ? (
                        <>
                          <p className="pr-2 text-right text-[10px] font-semibold leading-none text-rose-700">
                      ...
                      <p className="pl-2 text-[10px] font-semibold leading-none text-emerald-700">
